...
import {ExtendedCheckpoints} from "src/contracts/Checkpoints.sol";
import {ERC4626Math} from "src/contracts/ERC4626Math.sol";
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function version2State() external view returns (uint256) {
        return b;
    }
    ...
    function _claim(
        ...
        vs.isWithdrawalsClaimed[epoch][msg.sender] = true;
    }
